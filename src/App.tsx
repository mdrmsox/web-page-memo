  ...
  return (
    <article className="how-to-use-frame">
      ...
      <div className={`how-to-use-block ${isVisible ? 'visible' : ''}`}>
        ...
        <h3>このアプリについて</h3>
        <p>このWebアプリは、WebページのタイトルとURLを簡単に記録し、リスト表示するツールです。記録したページはワンクリックでアクセスできるため、記録しておきたいWebページを迅速に管理・利用できます。また、スマートフォンなどで通常のアプリとして登録でき、そうすることでより簡単にWebページを記録することができます。</p>
        <h3>使い方</h3>
        <p>このアプリはWebページのタイトルとURLを記録し、リスト形式で表示します。</p>
        <ol>
          <li>
            <h4>Webページの記録</h4>
            <p>画面下部にある「メモを追加」をクリックします。</p>
            <p>フォームが開くので、目的のページのタイトルとURLを入力します。</p>
            <p>入力が完了したら、「保存」ボタンを押してページを記録します。</p>
          </li>
          <li>
            <h4>記録したWebページの表示</h4>
            <p>記録したページはリストとして表示されます。</p>
            <p>リストの項目をクリックすると、目的のページが別のタブで開きます。</p>
          </li>
          <li>
            <h4>記録したページの削除</h4>
            <p>削除ボタンをクリックすることで記録したページを簡単に削除できます。</p>
          </li>
          <li>
            <h4>アプリとして登録</h4>
            <p>このアプリはスマートフォンなどで通常のアプリとして使用できます。</p>
            <p>アプリとして登録すると、ブラウザの共有機能を使って簡単にWebページを記録できます。</p>
            <h5>アプリの登録方法</h5>
            <p>ブラウザのメニューから「ホーム画面に追加」を選択してください。</p>
          </li>
          <li>
            <h4>ブックマークレットの活用</h4>
